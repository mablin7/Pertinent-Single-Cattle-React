        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text159 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text177 thq-heading-3">
                          $20/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text201 thq-body-large">
                          or $200 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  <p>
                    {props.plan3 ?? (
                      <Fragment>
                        <p className="pricing14-text169 thq-body-large">
                          Enterprise plan
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text204 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text190 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  <span>
                    {props.plan31 ?? (
                      <Fragment>
                        <span className="pricing14-text181 thq-body-large">
                          Enterprise plan
                        </span>
                      </Fragment>
                    )}
